...
{
    private int barWidth = 50; // the width of the color portion of the bar
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
    private float fontSize = 10.0f; // the size of the text
    ...
    private void newImage()
    {
        ...
        image.drawImage(rightImg, maxX + barImg.getWidth()-33, (image.getHeight() - rightImg.getHeight()) / 2);//the health life
        setImage(image);
    }

...
import static com.example.badapples.Server.getRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String row = deleterow.getText().toString();
                String servlet = String.format("http://10.0.2.2:8080/BadAPPles/Update?param1=%1$s&param2=%2$s", Integer.toString(File), row);

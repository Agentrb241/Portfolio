        ...
        try
        {
            if (file.exists()){
                ...
                while ((line = br.readLine()) != null)   //returns a Boolean value
                {
                    ...
                    int i=Integer.parseInt(column[2]);

                    if ((column[0].contains(" 0:")) || column[0].contains(" 1:") || column[0].contains(" 2:") || column[0].contains(" 3:") || column[0].contains(" 4:")) {
                        LatLong1.put(column[1] , i);

                    }
                    if ((column[0].contains(" 5:")) || column[0].contains(" 6:") || column[0].contains(" 7:") || column[0].contains(" 8:") || column[0].contains(" 9:")) {
                        LatLong2.put(column[1] , i);

                    }
                    if ((column[0].contains(" 10:")) || column[0].contains(" 11:") || column[0].contains(" 12:") || column[0].contains(" 13:") || column[0].contains(" 14:")) {
                        LatLong3.put(column[1] , i);
                    }
                ...
                File file1 = new File("/Library/apache-tomcat-10.0.5/webapps/BadAPPles/backUp-3/uber-raw-data-apr14.csv");
                ...
                BufferedReader br = new BufferedReader(new FileReader("/Library/apache-tomcat-10.0.5/webapps/BadAPPles/backUp-3/uber-raw-data-apr14.csv"));
                while ((line = br.readLine()) != null)   //returns a Boolean value
                {
                    String[] column = line.split(",");    // use comma as separator

                    if ((column[0].contains(" 0:")) || column[0].contains(" 1:") || column[0].contains(" 2:") || column[0].contains(" 3:") || column[0].contains(" 4:")) {
                        String temp = column[1] + " " + column[2]; // Lat + Long

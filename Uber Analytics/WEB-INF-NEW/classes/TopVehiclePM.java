    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if(file.exists()){
                ...
                stringArray[0] = "First Class" + ": " + String.valueOf(key1);
                stringArray[1] = "High Class" + ": " + String.valueOf(key3);
                stringArray[2] = "First Class" + ": " + String.valueOf(key2);
                stringArray[3] = "High Class" + ": " + String.valueOf(key4);

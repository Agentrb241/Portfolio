...
public class TopVehicleAM extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        File file = new File(TopVehicleAMCache);

        try {
            if(file.exists()){
                BufferedReader br = new BufferedReader(new FileReader(TopVehicleAMCache));
                String line = null;
                ...
                //write cache
                File myObj = new File(TopVehicleAMCache);

                if (myObj.createNewFile()){
                    FileWriter myWriter = new FileWriter(TopVehicleAMCache);
